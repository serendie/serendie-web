...
<CodeBox
  code={`claude mcp add --transport http serendie-design-mcp https://serendie.design/mcp`}
  language={"shell"}
/>
...
<PageARef href="https://cursor.com/ja/install-mcp?name=serendie-design-mcp&config=eyJ1cmwiOiJodHRwczovL3NlcmVuZGllLmRlc2lnbi9tY3AifQ%3D%3D">
  Cursor Deep Link
</PageARef>
